  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="glass-card-strong absolute bottom-24 left-1/2 z-20 w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 rounded-2xl p-5 md:left-auto md:right-6 md:translate-x-0"
      >
